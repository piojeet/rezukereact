        ...
        <div className="bg-btnColor lg:py-24 py-16 bg-no-repeat bg-contain bg-center bg-fixed" style={{ backgroundImage: `url(${'https://res.cloudinary.com/dwf7aydzq/image/upload/v1745757585/20250409_122315_efpvmc.avif'})` }}>
            <div className="max-w-[1500px] w-full px-6 lg:px-20 mx-auto">
                <div className='flex flex-col items-center gap-6 help--box'>
                    ...
                    <h2 className='lg:text-5xl text-3xl font-black text-primeryColor font-satoshi !leading-[1.2] text-center'>Your Next 10x Seminar Starts Now</h2>
                    <p className='text-xl text-primeryColor font-satoshi font-medium text-center'>Partner with us! 90% of attendees match your criteria, or we add replacements free.</p>
                    <div>
                        <NavLink
                            to="/buy"
                    ...
                    <p className='text-xl text-primeryColor font-satoshi font-medium text-center'>Only 2-3 advisors per area--grab your spot before it's gone.</p>
                </div>
            </div>
        </div>
    )
