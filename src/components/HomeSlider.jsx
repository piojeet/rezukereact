...
function HomeSlider() {
  useEffect(() => {
    ...
    // Cleanup event listeners jab component destroy ho
    return () => {
      if (nextBtn && prevBtn) {
            ...
            {slides.map((slide, index) => (
              <SwiperSlide key={index}>
                <div className='grid lg:grid-cols-2 gap-x-5'>
                  <div className='bg-primeryColor lg:rounded-[200px_12px_12px_12px] rounded-[150px_12px_12px_12px] content-end lg:p-12 p-10'>
